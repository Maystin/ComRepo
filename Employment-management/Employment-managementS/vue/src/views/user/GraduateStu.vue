<template>
    <div>
        ...
        <div style="margin-bottom: 20px">
            ...
            <el-input style="width: 260px;margin-left: 5px" placeholder="请输入学号" v-model="params.number"></el-input>
        ...
        <el-table :data="tableData" stripe>
            ...
            <el-table-column prop="university" label="读研院校"></el-table-column>
            <el-table-column prop="major" label="专业"></el-table-column>
            <el-table-column prop="sex" label="性别"></el-table-column>
            <el-table-column prop="gyear" label="毕业年份"></el-table-column>
            ...
            <el-table-column label="操作" width="230px">
                <template v-slot="scope">
                    <!--                    scope.row就是当前行数据-->
                    <el-button type="primary" @click="$router.push('/editGraduateStu?id=' + scope.row.id)">编辑</el-button>
                    <el-popconfirm
    ...
    export default {
        ...
        methods: {
            ...
            del(id) {            //定义一个del这样的方法去调用后台的接口
                request.delete("/graduateStu/delete/" + id).then(res => {
                    if (res.code === '200'){
