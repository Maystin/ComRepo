<template>
    <div>
        ...
        <div style="margin-bottom: 20px">
            <el-input style="width: 240px" placeholder="请输入名称" v-model="params.name"></el-input>   <!--绑定变量-->
        ...
        <el-table :data="tableData" stripe row-key="id" default-expand-all>
            ...
            <el-table-column label="操作" width="280px">
                <template v-slot="scope">
                    <!--                    scope.row就是当前行数据-->
                    <el-button type="success" v-if="!scope.row.pid" style="margin-right: 5px" @click="handleAdd(scope.row)">添加二级分类</el-button>
        ...
        <el-dialog title="添加二级分类" :visible.sync="dialogFormVisible" style="width: 85%" >
            <el-form :model="form" lable-width="100px" ref="ruleForm" :rules="rules">
